              ...
              <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-thumb">
                  ...
                  <div class="highlight-info">
                    ...
                    <a
                      href="https://www.youtube.com/watch?v=UwAkTLY9-r0&ab_channel=ConfluenceNITKurukshetra"
                      class="bi-youtube highlight-icon"
                    ></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-thumb">
                  ...
                  <div class="highlight-info">
                    ...
                    <a
                      href="https://www.youtube.com/watch?v=FXyHDBMVAgA"
                      class="bi-youtube highlight-icon"
                    ></a>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-thumb">
                  ...
                  <div class="highlight-info">
                    ...
                    <a
                      href="https://www.youtube.com/watch?v=IZ3SLDNCauQ&t=56s&ab_channel=ConfluenceNITKurukshetra"
                      class="bi-youtube highlight-icon"
                    ></a>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 col-12">
                ...
                <a
                  class="custom-btn custom-border-btn btn custom-link mt-3 me-3"
                  href="#section_3"
                >
                  Meet Speakers
                </a>

                <a class="custom-btn btn custom-link mt-3" href="#section_4">
                  Check out Schedule
                </a>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-12">
                <div class="speakers-thumb">
                  <img
                    src="images/avatar/startnight.jpg"
            ...
            <div class="row">
              <div class="col-lg-12 col-12">
                <h2 class="mb-5 text-center">
                  Next <u class="text-info">Schedules</u>
                </h2>
                ...
                <div class="tab-content mt-5" id="nav-tabContent">
                  ...
                  >
                    <div class="row border-bottom pb-5 mb-5">
                      ...
                      <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        <h4 class="mb-2">Star Night</h4>

                        <p>
                          The major attraction of Confluence, THE STAR NIGHT,
                          which has been graced by stars like:
                          ...
                          experience the leisure of grooving to the live beats.
                        </p>
                  ...
                  >
                    <div class="row border-bottom pb-5 mb-5">
                      ...
                      <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        <h4 class="mb-2">Folk Dance</h4>

                        <p>
                          India is a land of varied cultures and traditions.
                          Diversities in all spheres make the Indian culture
                          quite unique. Indianfolk and tribal dances are
                          products of different socio-economic set up and
                          traditions evolved over ages. It's an Inter college
                          Folk Dance competition Based on Cultural themes.
                        </p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        <h4 class="mb-2">Nukkad Natak</h4>

                        <p>
                          It's a form of theatrical performance and presentation
                          in outdoor public spaces without a specific paying
                          audience. It shows an exciting Play of characters
                          representing a social taboo.
                        </p>
                  ...
                  >
                    <div class="row border-bottom pb-5 mb-5">
                      ...
                      <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        <h4 class="mb-2">Groove Armada</h4>

                        <p>
                          Its a Major Group dance competition based on Hip Hop
                          theme.Over years Groove Armada has become established
                          as one of the NITKKR’s best-loved and biggest dance
                          acts. Best dance groups from the colleges of all
                          around india do participate in this competition.
                        </p>
                  ...
                  >
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        <h4 class="mb-2">Battle of bands</h4>

                        <p>
                          The competition between the extraordinary Bands within
                          nit kkr and from different colleges across india.A
                          Battle of the Bands is a music contest in which many
                          bands, usually rock or metal bands, but often musical
                          acts from a range of different styles, compete for the
                          title of "best band".
                        </p>
        ...
        <section className="faculties section-padding">
          <div className="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-12 col-12">
                <h2 class="mb-5 text-center">
                  Our <u class="text-info">FIC Students' Clubs</u>
                </h2>
              </div>
                    ...
                    <div class="speakers-thumb speakers-thumb-small">
                      ...
                      <div class="speakers-info">
                        <h5 class="speakers-title mb-0">
                          Dr. Paratibha Agarwal
                        </h5>
                        <p class="speakers-text mb-0">
                          Professor in Charge Students' Clubs{" "}
                        </p>
            ...
            <div class="row align-items-center">
              <div class="col-lg-7 col-12">
                <h2 class="text-white mb-4">
                  Become an <u class="text-info">event speaker?</u>
                </h2>
        ...
        <section class="venue section-padding">
          <div class="container">
            <div class="row">
              <div class="col-lg-12 col-12">
                <h2 class="mb-5">
                  Here you go <u class="text-info">Venue</u>
                </h2>
              </div>
              ...
              <div class="col-lg-6 col-12">
                <iframe
                  class="google-map"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2254.659149332004!2d76.81532307825445!3d29.946852386264155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390e3f51801954b5%3A0x14d79f026b1ae4ec!2sNational%20Institute%20of%20Technology%2C%20Kurukshetra!5e0!3m2!1sen!2sin!4v1657652808076!5m2!1sen!2sin"
                  width="100%"
                  height="371.59"
                  allowfullscreen=""
                  loading="lazy"
                ...
                <div class="venue-thumb bg-white shadow-lg">
                  ...
                  <div class="venue-info-body">
                    <h4 class="d-flex">
                      ...
                      <h style={{ color: "black" }}>
                        WRX8+355, NIT, Mirzapur Part, Haryana 136119
                      </h>
                    </h4>
