                ...
                <section className="faculties section-padding">
                    <div className="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-12 col-12">
                                <h2 class="mb-5 text-center">Our <u class="text-info">Faculties</u></h2>

                            </div>
                            <div class="row align-items-center justify-content-around mt-5">

                                <div class="faculty-card card col-lg-3 col-12 m-5">
                                <img src={bg} class="card-img-top fc-img" alt="" />
                                    <div class="card-body ">
                                ...
                                <div class="faculty-card card col-lg-3 m-5">
                                <img src={bg} class="card-img-top fc-img" alt="" />
                                    <div class="card-body">
                                    <h5 class="text-white">Name</h5>
                                    <p class="text-white">Profile</p>
